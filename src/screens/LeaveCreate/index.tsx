...
const LeaveCreate = ({navigation}: any) => {
  ...
  return (
    <View style={[layout.page]}>
      ...
      />
      <Header title="Leave Create" onPress={() => navigation.goBack()} />
      <ScrollView
        style={{flex: 1}}
        ...
        <View
          ...
          <Gap height={10} />
          <Text style={[blackTextStyle]}>Start Date</Text>
          ...
          <Gap height={10} />
          <Text style={[blackTextStyle]}>End Date</Text>
          <View style={[styles.input]}>
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => setStartShow(true)}
      ...
      <ModalConfirmation
        ...
        confirmText="Request leave permission"
