...
const OffdayCreate = ({navigation}: any) => {
  ...
  return (
    <View style={[layout.page]}>
      ...
      />
      <Header title="Off Day Create" onPress={() => navigation.goBack()} />
      <ScrollView
        style={{flex: 1}}
      ...
      <ModalConfirmation
        ...
        confirmText="Request off day permission"
